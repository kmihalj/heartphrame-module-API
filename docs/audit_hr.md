...
Rutu registrira i implementira opcionalni Audit modul. Parametri upita mogu
filtrirati
...
Bez Audit modula ova ruta nije registrirana. API jezgra ne implementira niti
izlaže smanjeni pričuvni audit zapisnik.
